...
/* The examples use simple Pre-Shared-Key configuration that you can set via
   ...
   ---EN ESTE CASO SE DESACTIVAN DESDE EL MENUCONFIG---
*/
...
/* Creacion de vectores auxiliares para almacenar informacion */
...
/* Creacion de variables auxiliares para el manejo del tamano de los vectores auxiliares */
...
/* Se ignora puesto que se desactiva la autenticacion PKI desde el menuconfig */
...
/* Se definen datos iniciales y por defecto */
...
/* Todas las funciones callback seran llamadas dependiento de la peticion hecha y del recurso al que se desea acceder*/
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
// NAME CALLBACKS
static void
                  ...
                  coap_pdu_t *response)
{
    ...
    /* Manejo de errores */
        ...
        /* Verificar que los valores esten en formato hexadecimal */
...
static void coap_example_server(void *p)
{
    ...
    int have_ep = 0;
    // Puerto configurado en menuconfig
    ...
    while (1) {
        ...
        /* Configuracion de conexion Wi-Fi */
#if LWIP_IPV6
